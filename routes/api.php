...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::put('/user-ips', [UserIpController::class, 'MultipleUpdate'])->middleware("permission:user.access.user.ip.create|user.access.user.ip.edit|user.access.user.ip.delete|user.access.user.ip.view");
